...
This project features a comprehensive simulation of a Mars rover ("Curiosity"), focusing on the development of a stack-based command interpreter. The repository includes a modular engine to manage Martian terrains with randomized map generation and target tracking. It also integrates a safety monitoring system using state-machine observers to verify the rover's behavior during navigation.
